...
} from "@social/components/docs/MobileNavigation";
import { MobileSearch, Search } from "@social/components/docs/Search";
import { Logo } from "@social/components/logo/sotsial";
import { Link } from "@social/ui/link";
import { ThemeToggle } from "@social/ui/theme-toggle";
		...
		<div className="flex items-center gap-5">
			...
			<div className="hidden min-[416px]:contents">
				{session ? (
					...
					<Button href="/continue">Sign in</Button>
				)}
			</div>
		</div>
	);
