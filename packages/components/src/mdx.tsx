...
import { Feedback } from "@social/components/docs/Feedback";
import { Heading } from "@social/components/docs/Heading";
import { Prose } from "@social/components/docs/Prose";
import { Link } from "@social/ui/link";
import clsx from "clsx";
import Image, { type ImageProps } from "next/image";

export { Button } from "@social/components/docs/Button";
export {
	Code as code,
	CodeGroup,
	Pre as pre,
} from "@social/components/docs/Code";
