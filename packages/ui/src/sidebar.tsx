...
import { forwardRef, type default as React, useId } from "react";
		...
		>
			{(Array.isArray(keys) ? keys : keys.split("")).map((char, index) => (
				<Badge
					key={char}
					className={clsx([
						"min-w-[2ch] text-center capitalize text-zinc-400 group-data-[focus]:text-white forced-colors:group-data-[focus]:text-[HighlightText]",
